...
// Add this function inside your ResultsTables component, before the return statement
...
async function handleTouchFields(
  location,
  setFieldTouched,
  values,
  validateForm
  ...
  const fieldsByLocation = {
    "/OccupationalFinancialInformation/": [
      ...
      "EmploymentStatus_TradingEntity",
      "EmploymentStatus_BusinessName",
      "EmploymentStatus_EmploymentStatus_BusinessOperateWithOutNo_Impact",
      "EmploymentStatus_NatureOfBusiness",
      "EmploymentStatus_TotalGrossIncome",
      "EmploymentStatus_NumberOfEmployees",
      "EmploymentStatus_TotalGrossIncome",
      "EmploymentStatus_StartDateOfBusiness",
      "EmploymentStatus_NetProfit",
      "EmploymentStatus_BusinessRegistrationNo",
      "EmploymentStatus_CountryOfEmployment",
      "SecondOccupation_OccupationJobTitle",
      "SecondOccupation_EmploymentType",
      "SecondOccupation_Other",
      "SecondOccupation_primaryOccupation", //usamasaeed
      "SecondOccupation_SecondaryOccupation", //usamasaeed
      "SecondOccupation_primaryWorkHours", //usamasaeed
      "SecondOccupation_SecondWorkHours", //usamasaeed
      "SecondOccupation_workPerYear", //usamasaeed
    ...
    "/Health_MedicalHistory/Q1": [
      ...
      "heartDiseaseConditions_datesAndReasons0",
      "heartDiseaseConditions_ongoingTreatment0",
      //set 1
      ...
      "heartDiseaseConditions_datesAndReasons1",
      "heartDiseaseConditions_ongoingTreatment1",
      ...
      "heartDiseaseConditions_datesAndReasons2",
      "heartDiseaseConditions_ongoingTreatment2",
      //set 3
      ...
      "heartDiseaseConditions_datesAndReasons3",
      "heartDiseaseConditions_ongoingTreatment3",
      //set 4
      ...
      "heartDiseaseConditions_datesAndReasons4",
      "heartDiseaseConditions_ongoingTreatment4",
      //set 5
      ...
      "heartDiseaseConditions_datesAndReasons5",
      "heartDiseaseConditions_ongoingTreatment5",
      //set 6
      ...
      "heartDiseaseConditions_datesAndReasons6",
      "heartDiseaseConditions_ongoingTreatment6",
    ],
    ...
    "/LifestyleInformation/Q2": [
      ...
      "hazardousActivitiesSports_Weeks",
    ...
    "/FamilyMedicalHistory/Q1": [
      ...
      "FamilyMedicalHistory_Type_0",
      "FamilyMedicalHistory_otherDescription_0",
      "FamilyMedicalHistory_AgeDiagnosis_0",

      //set 1
      "FamilyMedicalHistory_Type_1",
      "FamilyMedicalHistory_otherDescription_1",
      "FamilyMedicalHistory_AgeDiagnosis_1",
      //set 2
      "FamilyMedicalHistory_Type_2",
      "FamilyMedicalHistory_otherDescription_2",
      "FamilyMedicalHistory_AgeDiagnosis_2",
      //set 3
      "FamilyMedicalHistory_Type_3",
      "FamilyMedicalHistory_otherDescription_3",
      "FamilyMedicalHistory_AgeDiagnosis_3",

      // step 0
      // "FamilyMedicalHistory_FamilyMemberAffectedCancer",
      "FamilyMedicalHistory_CancerType_0",
      "FamilyMedicalHistory_AgeDiagnosisCancer_0",
      // step 1
      // "FamilyMedicalHistory_FamilyMemberAffectedCancer",
      "FamilyMedicalHistory_CancerType_1",
      "FamilyMedicalHistory_AgeDiagnosisCancer_1",
      // step 2
      "FamilyMedicalHistory_CancerType_2",
      "FamilyMedicalHistory_AgeDiagnosisCancer_2",
      // step 3
      "FamilyMedicalHistory_CancerType_3",
      "FamilyMedicalHistory_AgeDiagnosisCancer_3",

      // step0
      "FamilyMedicalHistory_DiabetesType_0",
      "FamilyMedicalHistory_FamilyMemberAffectedDiabetes",
      "FamilyMedicalHistory_AgeDiagnosisDiabetes_0",
      // step1
      "FamilyMedicalHistory_DiabetesType_1",
      "FamilyMedicalHistory_AgeDiagnosisDiabetes_1",
      // step2
      "FamilyMedicalHistory_DiabetesType_2",
      "FamilyMedicalHistory_AgeDiagnosisDiabetes_2",
      // step3
      "FamilyMedicalHistory_DiabetesType_3",
      "FamilyMedicalHistory_AgeDiagnosisDiabetes_3",

      // "FamilyMedicalHistory_FamilyMemberAffectedMentalHealthConditions",
      // mental step0
      "FamilyMedicalHistory_MentalHealthConditionsType_0",
      "FamilyMedicalHistory_AgeDiagnosisMentalHealthConditions_0",
      "FamilyMedicalHistory_otherDescriptionMentalHealthConditions_0",
      // mental step1
      "FamilyMedicalHistory_MentalHealthConditionsType_1",
      "FamilyMedicalHistory_AgeDiagnosisMentalHealthConditions_1",
      "FamilyMedicalHistory_otherDescriptionMentalHealthConditions_1",
      // mental step2
      "FamilyMedicalHistory_MentalHealthConditionsType_0",
      "FamilyMedicalHistory_AgeDiagnosisMentalHealthConditions_2",
      "FamilyMedicalHistory_otherDescriptionMentalHealthConditions_2",
      // mental step3
      "FamilyMedicalHistory_MentalHealthConditionsType_3",
      "FamilyMedicalHistory_AgeDiagnosisMentalHealthConditions_3",
      "FamilyMedicalHistory_otherDescriptionMentalHealthConditions_3",
    ],
  };

  // Determine the fields to be validated based on the current path
  const fieldsToTouch =
    fieldsByLocation[`/${currentPath}/${cLocation || ""}`] || [];

  // Use the touchFields helper to validate and touch the fields
  const touchFieldsResult = await touchFields(
    setFieldTouched,
    fieldsToTouch,
    values,
    validateForm
